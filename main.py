...
if not TMDB_API_KEY:
    ...
    raise ValueError("TMDB_API_KEY is missing. Put it in .env as TMDB_API_KEY=xxxxx")
...
TFIDF_MATRIX_PATH = os.path.join(BASE_DIR,"tf_idfmatrix.pkl")
...
async def tmdb_search_movies(query: str,page:int = 1)-> Dict[str,Any]:
    """ RAW 
    TMDB response for keyword search (MULTIPLE Results)
